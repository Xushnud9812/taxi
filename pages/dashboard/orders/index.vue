    ...
    <el-card class="box-card">
      ...
      <div class="title-box-top">
        <div class="title-top-left">
          <h4 class="title-page">Barcha o'quvchilar ro'yhati</h4>
        </div>
        ...
        <div class="title-box-right flex">
          ...
          <div>
            <el-button size="medium" class="bg-btn" @click="openModalAdd">
              <i class="el-icon-plus"></i> O'quvchi qo'shish</el-button
            >
          </div>
        </div>
      </div>
        ...
        <table v-if="tableData1 != null">
          ...
          <tbody>
            ...
            >
              ...
              <td>
                <div v-if="item.oplata" class="name">
                  <span class="true"> To'langan </span>
                </div>
                <div v-if="item.oplata == false" class="name">
                  <span class="false"> To'lanmagan </span>
                </div>
              </td>
              <td>
